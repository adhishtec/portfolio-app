  ...
  <React.Fragment>
    <CardContent>
      ...
      <Typography sx={{ mb: 1.5 }} color="text.secondary">
        Obsessed with exploring the world, meeting new people. I’m not going to lie: I think I have a pretty good travel blog. (You probably do too if you’re here.) I work hard to provide excellent practical travel advice to help you travel better, but I’m not the only great travel blogger out there. In fact — and I know this might be shocking — there’s a lot about travel that I’m not an expert on. Family travel? No idea. Travel as a woman? Clueless. Information on hotels? Only a little. Photography? I can manage to turn my camera on if that counts. Food expert? Only at eating it.
        <p>Hi I am Adhish and welcome to my Travel blog 'The story of globetrotter' </p>
...
<h4>My destinations</h4>
  <ImageList className='countries-list' sx={{ width: 500, height: 350, backgroundColor:'#03395B', padding:1 }} cols={3} rowHeight={220}>
